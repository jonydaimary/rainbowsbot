...
client.on('guildMemberAdd', (member) => {
    ...
    .addField('Информация о сервере', `Rainbow's Server — это стремительно развивающийся сервер Discord. Основной тематикой сервера является программирование. Здесь всегда можно попросить помощи у опытных и начинающих программистов.\n Обязательно прочитай <#469599206991200256>. \n **Мы рады, что ты зашел к нам** \n По вопросам обращайся к Главному администратору\n\nЧеловек на сервере: **${member.guild.memberCount}**\n`)
    .setColor('00ff00')
