  ...
  if (command === 'a') {
    ...
    if (command === 'g') {
     ...
     if (command === 'j') {
        message.delete();
        let embed = new Discord.RichEmbed()
        .addField(`ДОНАТ`, `**DONATE** - пожертвование\nВы можете пожертвовать некоторую сумму нашему серверу. При пожертвовании от **50₽** вы получаете роль <@&469612127049482240> . При пожертвовании от **100₽** вы получаете роль <@&469612147555565568>\nВсе деньги идут на развитие сервера`)
        .setColor(`#800080`)
        .setFooter(`Администрация | 09.08.2018`)
